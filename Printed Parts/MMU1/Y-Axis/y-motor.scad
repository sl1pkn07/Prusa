...
module y_motor_base(){
        ...
        translate([29,-21+50,0]){
            ...
            difference(){
                union(){
                    ...
                    translate([-15.5,-15.5,0]) cylinder(h=10,r=5.5,$fn=50);
                    translate([-15.5,+15.5,0]) cylinder(h=10,r=5.5,$fn=50);
                    translate([-21,7,0]) rotate([0,0,45]) cube([2, 2, 10]);

                    // End stop
                    translate([-10.5,+15.5,0]) cylinder(h=10,r=5.5,$fn=50);
                    ...
                    translate([-29,-21,0]) cube([14,30,10]);
                }
    ...
    // Front holding part
    translate([0,10,0]) cylinder(h=10,r=8,$fn=80);
    translate([0,20,5]) cube([16,20,10],center=true);
    translate([0,30,0]) cylinder(h=10,r=8,$fn=80);
}
...
module y_motor_holes(){
    translate([29,-21+50,0]){
        ...
        // Screw head holes
        translate([-15.5,-15.5,-1]) cylinder(h=10,r=1.8,$fn=20);
        translate([-15.5,+15.5,-1]) cylinder(h=10,r=1.8,$fn=20);

        // Screw holes
        translate([-15.5,-15.5,7]) cylinder(h=7,r=3.5,$fn=30);
        translate([-15.5,+15.5,7]) cylinder(h=25,r=3.5,$fn=30);
    }
    translate([0,10,-1]) cylinder(h=12,r=4.2,$fn=50);
    translate([0,30,-1]) cylinder(h=12,r=4.2,$fn=50);

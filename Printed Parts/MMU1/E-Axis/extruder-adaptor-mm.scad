...
module ext_body_CP(){
  difference(){
    ...
    translate([36.5,-36.5,-1]) cylinder(=60,r=1.6,$fn=30);
    ...
    translate([17.5,-0,15]) rotate([90,0,0]) cylinder(=25,r=6,$fn=30);
    translate([17.5,-2,15]) rotate([90,0,0]) cylinder(=10,r=10,$fn=30);
    ...
    translate([-5,-24,9]) rotate([0,90,0]) cylinder(=44,r=1.6,$fn=30);
    translate([25,-24,9]) rotate([0,90,0]) cylinder(=5,r2=1.6,r1=3,$fn=30);

    translate([-3,-24,9]) rotate([0,90,0]) cylinder(=6,r=3,$fn=30);
...
module Y_part_holes(){
  translate([17.5,-36.5,-1]) cylinder(=60,r=1.6,$fn=30);
  translate([11,-14,-1]) cylinder(=60,r=1.6,$fn=30);
  translate([24,-14,-1]) cylinder(=60,r=1.6,$fn=30);
  translate([11,-27,-1]) cylinder(=60,r=1.6,$fn=30);
  translate([24,-27,-1]) cylinder(=60,r=1.6,$fn=30);
}

module Y_teflon_tubes(){
  translate([17.5,-7,15]) rotate([90,0,0]) cylinder(=15,r=2,$fn=30);
  translate([17.5,-20,15]) rotate([90,0,13]) cylinder(=40,r=2,$fn=30);
  translate([17.5,-20,15]) rotate([90,0,-13]) cylinder(=40,r=2,$fn=30);
}
...
module Y_part_forward(){
  difference(){
    ...
    translate([17.5,-36.5,19]) cylinder(=4,r=2.8,$fn=30);
    translate([11,-14,19]) cylinder(=4,r=2.8,$fn=30);
    translate([24,-14,19]) cylinder(=4,r=2.8,$fn=30);
    translate([11,-27,19]) cylinder(=4,r=2.8,$fn=30);
    translate([24,-27,19]) cylinder(=4,r=2.8,$fn=30);
